...
describe('#head',() => {
  it(`return "These two arrays are the same" for [1,2,3] and 2`, () => {
    assert.strictEqual(assertArraysEqual(middle([1,2,3]),[2]), "These two arrays are the same.");
  });

  it(`return "These two arrays are the same" for [1,2,3,4] and [2,3]`, () => {
    assert.strictEqual(assertArraysEqual(middle([1,2,3,4]),[2,3]), "These two arrays are the same.");
  });

  it(`return "These two arrays are NOT the same" for [1,2,3,4,5] and [2,3]`, () => {
    assert.strictEqual(assertArraysEqual(middle([1,2,3,4,5]),[2,3]), "These two arrays are NOT the same.");
  });
